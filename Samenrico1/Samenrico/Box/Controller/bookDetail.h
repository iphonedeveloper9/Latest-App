...
@interface bookDetail : UIViewController<SKProductsRequestDelegate, SKPaymentTransactionObserver>{
    ...
    NSURLConnection *getAllarticalesCon;
    NSMutableData *fetchData;
    
    AppDelegate *appDelegate;
}

@property (nonatomic, retain) NSMutableDictionary *dictAllarticales;
@property (retain, nonatomic) IBOutlet UIView *header_view;
@property (retain, nonatomic) IBOutlet UIButton *btn_BackButton;

@property (retain, nonatomic) IBOutlet UITableView *tblData;
@property (retain, nonatomic) IBOutlet UIView *about_scrb;
@property (retain, nonatomic) IBOutlet UIView *fuull_issue;
